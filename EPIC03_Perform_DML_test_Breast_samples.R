...
##### RUN DML
#####----------------------------------------------------------------------#####
test_cancer_vs_control <- run_test(pbmc.cancer, pbmc.control, bVals)
...
test_crc_vs_control <- run_test(pbmc.crc, pbmc.control, bVals)
...
test_lung_vs_control <- run_test(pbmc.lung, pbmc.control, bVals)
...
test_breast_vs_control <- run_test(breast.cancer, breast.control, bVals)
...
ggsave(plot = dotplot.kegg, filename = "dotplot_KEGG_DML_genes.svg", path = path.to.03.output, device = "svg", width = 14, height = 10)
ggsave(plot = dotplot.go, filename = "dotplot_GO_DML_genes.svg", path = path.to.03.output, device = "svg", width = 14, height = 10)
